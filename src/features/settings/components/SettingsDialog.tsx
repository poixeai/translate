    ...
    return (
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                >
                    <DialogTitle className="sr-only">{t("common.settings.dialog.dialog_title")}</DialogTitle>
                    <DialogDescription className="sr-only">{t("common.settings.dialog.dialog_description")}</DialogDescription>
